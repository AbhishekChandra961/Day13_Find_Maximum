...
public class refactor2 <T extends Comparable<T>>
{
	...
	public refactor2(T value1, T value2, T value3) 
	{
		super();
		this.value1 = value1;
		this.value2 = value2;
	...
	public static void main(String[] args)
	{
		...
		refactor2<Integer> integer = new refactor2<Integer>(intNumber1,intNumber2,intNumber3);
		integer.findMax();
		refactor2<Double> floatingNumber = new refactor2<Double>(doubleNumber1,doubleNumber2,doubleNumber3);
		floatingNumber.findMax();
		refactor2<String> stringValue  = new refactor2<String>(fruit1,fruit2,fruit3);
		stringValue.findMax();
	}
}
